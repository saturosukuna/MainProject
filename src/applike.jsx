  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
  path="/admin"
  element={role === "admin" && contract ? 
    <AdminPage contract={contract} account={account} /> : 
    <Navigate to="/" />}
 />
<Route
  path="/staff"
  element={role === "staff" && contract ? 
    <StaffPage contract={contract} account={account} /> : 
    <Navigate to="/" />}
/>
<Route
  path="/student"
  element={role === "student" && contract ? 
    <StudentPage contract={contract} account={account} /> : 
    <Navigate to="/" />}
/>
